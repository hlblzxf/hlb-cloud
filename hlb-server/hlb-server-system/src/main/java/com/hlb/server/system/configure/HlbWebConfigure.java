...
import com.hlb.server.system.properties.HlbSwaggerProperties;
...
@Configuration
@EnableSwagger2
public class HlbWebConfigure {

    @Autowired
    private HlbServerSystemProperties hlbServerSystemProperties;
    ...
    public Docket swaggerApi() {
        HlbSwaggerProperties swagger = hlbServerSystemProperties.getSwagger();
    ...
    private ApiInfo apiInfo(HlbSwaggerProperties swagger) {
        return new ApiInfo(
                swagger.getTitle(),
    ...
    private SecurityScheme securityScheme(HlbSwaggerProperties swagger) {
    ...
    private SecurityContext securityContext(HlbSwaggerProperties swagger) {
    ...
    private AuthorizationScope[] scopes(HlbSwaggerProperties swagger) {
